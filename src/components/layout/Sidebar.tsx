...
const NAV: NavItem[] = [
  ...
  { to: '/ke-hoach-truong', label: 'Kế hoạch hoạt động', icon: BookOpenCheck, moduleKey: 'chuyen_mon' },
  { to: '/lich-cong-tac', label: 'Lịch công tác', icon: CalendarDays, moduleKey: 'lich_cong_tac' },
  { to: '/phan-tich-van-ban-ai', label: 'Tóm tắt văn bản AI', icon: FileSearch, moduleKey: 'ai_agent' },
  ...
  { to: '/kho-tai-nguyen', label: 'Tài nguyên & Tiện ích', icon: BookMarked },
